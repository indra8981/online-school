  ...
  return (
    <Router>
      <div className="container">
        ...
        <Route path="/classroom/:classRoomId" exact component={withAuth(Classroom)} />
        <Route path="/assignment/:assignmentId" exact component={withAuth(Assignment)} />
        <Route path="/register" component={SignUp} />
        <Route path="/login" component={LogIn} />
        <Route path="/create-classroom" component={withAuth(CreateClassRoom) } />
        <Route path="/create-assignment/:classRoomId/" component={withAuth(CreateAssignment) } />
      </div>
    </Router>
  );
}
